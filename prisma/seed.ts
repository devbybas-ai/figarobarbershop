  ...
  const barbersData = [
    {
      ...
      tagline: "Where every cut tells a story. 20+ years of mastering the craft.",
      specialties: [
        "Classic Cuts",
    ...
    },
    {
      ...
      tagline: "Blending tradition with modern style. Your vision, perfected.",
      specialties: ["Modern Fades", "Textured Crops", "Classic Tapers", "Beard Design"],
      commissionRate: 50,
    ...
    },
    {
      ...
      tagline: "Precision is not a skill, it's a standard.",
      specialties: ["Skin Fades", "Line-Ups", "Hair Design", "Kids Cuts"],
      commissionRate: 45,
    ...
    },
    {
      ...
      tagline: "Energy, creativity, and a fresh cut every time.",
      specialties: ["Creative Styles", "Fades", "Beard Trims", "Hot Towel Shaves"],
      commissionRate: 45,
    ...
    },
    {
      ...
      tagline: "Clean lines, sharp style. Every detail matters.",
      specialties: ["Textured Cuts", "Beard Work", "Scissor Cuts", "Styling"],
      commissionRate: 45,
    ...
    },
    {
      ...
      tagline: "Sharp fades, sharper attention to detail.",
      specialties: ["Sharp Fades", "Buzz Cuts", "Edge-Ups", "Modern Styles"],
      commissionRate: 40,
